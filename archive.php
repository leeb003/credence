<?php
/* 
 * The template for showing archive pages
*/
get_header();
        ...
        <div class="row">
            <div class="col-md-12">
                <h1>
					<?php
                        if ( is_day() ) :
                            printf( __( 'Daily Archives: %s', 'shcreate' ), get_the_date() );

                        elseif ( is_month() ) :
                            printf( __( 'Monthly Archives: %s', 'shcreate' ), get_the_date( _x( 'F Y', 'monthly archives date 
format', 'shcreate' ) ) );

                        elseif ( is_year() ) :
                            printf( __( 'Yearly Archives: %s', 'shcreate' ), get_the_date( _x( 'Y', 'yearly archives date form
at', 'shcreate' ) ) );

                        else :
                            _e( 'Archives', 'shcreate' );
