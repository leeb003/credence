...
class Nav_Menu_Images_Admin extends Nav_Menu_Images {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'nmi-scripts', get_template_directory_uri() . '/theme/nav-menu-images/inc/nmi.js', array( 'media-upload', 'thickbox' ), '1', true );
		...
		if ( version_compare( $wp_version, '3.5', '>=' ) ) {
			...
			wp_enqueue_script( 'nmi-media-view', get_template_directory_uri() . '/theme/nav-menu-images/inc/media-view.js', array( 'jquery', 'media-editor', 'media-views', 'post' ), '1.1', true );
		}
